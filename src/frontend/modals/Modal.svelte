...
<!-- v1.3.0 https://svelte.dev/repl/033e824fad0a4e34907666e7196caec4-->
...
{#if Component}
  <div
    ...
    style="{cssBg}"
  >
    <div class:wrap="{!unstyled}" bind:this="{wrap}" style="{cssWindowWrap}">
      <div
      ...
      >
        {#if state.closeButton}
          ...
          {/if}
        {/if}
        <div class:content="{!unstyled}" style="{cssContent}">
